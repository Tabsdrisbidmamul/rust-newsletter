...
#[tracing::instrument(
    name = "Validate credentials from supplied header",
...
#[tracing::instrument(
    name = "Verify password for password candidate",
...
fn verify_password_hash(
    ...
    // PHC format ${algorithm}${algorithm version}${,-separated algorithm parameters}${hash}${salt}
